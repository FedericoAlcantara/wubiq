...
public final class CommandKeys {
	...
	public static final String READ_PRINT_REQUEST_ATTRIBUTES = "a1";
	public static final String READ_PRINT_JOB_ATTRIBUTES = "a2";
	public static final String READ_DOC_ATTRIBUTES = "a3";
