 ...
 *
 */
public class ProxyAdapterMaster implements MethodInterceptor {
	private IDirectConnectorQueue queue;
	private UUID objectUUID;
	private List<String> filtered;

	public ProxyAdapterMaster(IDirectConnectorQueue queue,
			String filtered[]) {
		this.queue = queue;
